...
@property (nonatomic, copy) NSString *appSchemesDictionaryName;
@property (nonatomic, copy) NSString *appSchemesDictionaryUrl;
...
- (void)getAppSchemeWithAppId:(NSString *)appId withSuccess:(void (^)(NSArray *))successBlock withFailure:(void (^)(NSError *))failureBlock;
@end
